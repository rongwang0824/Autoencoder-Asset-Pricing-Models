...
Data were constructed and preprocessed in a separate repository: [Data-for-Asset-Pricing](https://github.com/rongwang0824/Data-for-Asset-Pricing).
...
```bash
python3 model_AE.py --model AE2 --num_factors 1 3 6 9
```
